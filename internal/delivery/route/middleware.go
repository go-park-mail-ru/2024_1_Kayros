...
func AddMiddleware(cfg *config.Project, db *sql.DB, redisClientSession *redis.Client, redisClientCsrf *redis.Client, minioClient *minio.Client, mux *mux.Router, logger *zap.Logger, m *metrics.Metrics) http.Handler {
