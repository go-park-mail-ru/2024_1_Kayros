...
('Салат "Антипасти"', 'Итальянский салат с мясными деликатесами', 2, 3, 200, 550, NULL, NULL, NULL, '/minio-api/foods/8.jpg'),
('Минестроне', 'Традиционный итальянский овощной суп', 2, 2, 300, 430, NULL, NULL, NULL, '/minio-api/foods/9.jpg'),
