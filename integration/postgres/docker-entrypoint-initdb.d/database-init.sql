...
(
    ...
    img_url     TEXT CONSTRAINT user_img_url CHECK(LENGTH(img_url) <= 60) DEFAULT 'http://localhost:9000/users/default.jpg' NOT NULL,
...
(
    ...
    img_url           TEXT CONSTRAINT restaurant_img_url CHECK(LENGTH(img_url) <= 60) DEFAULT 'http://localhost:9000/restaurants/default.jpg' NOT NULL,
