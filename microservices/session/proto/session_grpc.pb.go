...
const (
	SessionManager_SetSession_FullMethodName    = "/session.SessionManager/SetSession"
	SessionManager_GetSession_FullMethodName    = "/session.SessionManager/GetSession"
	SessionManager_DeleteSession_FullMethodName = "/session.SessionManager/DeleteSession"
)
...
func (c *sessionManagerClient) SetSession(ctx context.Context, in *SetSessionData, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, SessionManager_SetSession_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SessionManager_SetSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SessionManager_SetSession_FullMethodName,
	}
