...
func file_food_food_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_food_food_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*RestId); i {
			case 0:
				return &v.state
			case 1:
		...
		file_food_food_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*FoodId); i {
			case 0:
				return &v.state
			case 1:
		...
		file_food_food_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Food); i {
			case 0:
				return &v.state
			case 1:
		...
		file_food_food_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_food_food_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_food_food_proto_msgTypes[5].Exporter = func(v any, i int) any {
