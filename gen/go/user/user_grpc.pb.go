...
func (c *userManagerClient) GetData(ctx context.Context, in *Email, opts ...grpc.CallOption) (*User, error) {
	...
	out := new(User)
	err := c.cc.Invoke(ctx, UserManager_GetData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userManagerClient) UpdateData(ctx context.Context, in *UpdateUserData, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
	err := c.cc.Invoke(ctx, UserManager_UpdateData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userManagerClient) UpdateAddress(ctx context.Context, in *AddressData, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, UserManager_UpdateAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userManagerClient) SetNewPassword(ctx context.Context, in *PasswordsChange, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, UserManager_SetNewPassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userManagerClient) IsPassswordEquals(ctx context.Context, in *PasswordCheck, opts ...grpc.CallOption) (*wrapperspb.BoolValue, error) {
	...
	err := c.cc.Invoke(ctx, UserManager_IsPassswordEquals_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userManagerClient) UpdateAddressByUnauthId(ctx context.Context, in *AddressDataUnauth, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, UserManager_UpdateAddressByUnauthId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userManagerClient) GetAddressByUnauthId(ctx context.Context, in *UnauthId, opts ...grpc.CallOption) (*Address, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Address)
	err := c.cc.Invoke(ctx, UserManager_GetAddressByUnauthId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
